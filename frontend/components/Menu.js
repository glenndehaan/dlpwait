    ...
    render() {
        ...
        return (
            <div className="grid grid-cols-2 grid-rows-3 gap-8 w-full h-full max-w-5xl px-4 mx-auto">
                ...
                <button aria-label="Open Weather View" className={clsx('border rounded-lg shadow-lg bg-white dark:bg-gray-800 dark:border-gray-700 text-center flex flex-col items-center justify-center gap-3', view === 'weather' && 'text-blue-600 dark:text-blue-400')} onClick={() => switchViews('weather')}>
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className="fill-current h-16 w-16">
