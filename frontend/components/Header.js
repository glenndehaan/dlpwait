            ...
            <div className={clsx("grid grid-cols-2 gap-1 p-2 px-4 bg-white dark:bg-gray-800", !parkOpen && !parkEMT && "grid-rows-2" , (parkOpen || parkEMT) && "grid-rows-3")} onClick={() => this.toggleDebug()}>
                ...
                <div className="relative inline-block w-full">
                    ...
                    <select id="sort" disabled={view === 'weather'} className="shadow appearance-none border rounded w-full py-2 px-3 pr-7 text-gray-700 mt-1 bg-white leading-tight focus:outline-none focus:shadow-outline dark:bg-gray-700 dark:border-gray-600 dark:text-white disabled:bg-gray-100 disabled:dark:bg-transparent" onChange={(e) => this.updateSort(e)}>
                        ...
                        <option selected={sort === "REGION"} value="REGION">Region</option>
                ...
                {updated !== null &&
                    <div className="col-span-2 text-center text-sm border-t pt-2 timer-container">
                        ...
                        <div className="timer timer-content-3">
                            Current weather: {weather.current ? weather.current.wmo.description : ''}, {weather.current ? weather.current.temperature : ''}&#8451;
                        </div>
                        <div className="timer timer-content-4">
                            Forecasted weather: {weather.expected ? weather.expected.wmo.description : ''}, {weather.expected ? weather.expected.temperature : ''}&#8451;
                        </div>
                    </div>
                }
            </div>
